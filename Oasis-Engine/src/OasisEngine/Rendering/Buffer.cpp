...
namespace Oasis {
	...
	VertexBuffer* VertexBuffer::Create(float* vertices, uint32_t size) {
		...
		case RendererAPI::RenderBackend::None:
			...
			return nullptr;
		case RendererAPI::RenderBackend::OpenGL: return new OpenGLVertexBuffer(vertices, size);
		}
	...
	IndexBuffer* IndexBuffer::Create(uint32_t* indices, uint32_t size) {
		...
		case RendererAPI::RenderBackend::None:
			...
			OE_COREASSERT(false, "Running Oasis Engine without a render backend is currently unsupported");
			return nullptr;
		case RendererAPI::RenderBackend::OpenGL: return new OpenGLIndexBuffer(indices, size);
		}
